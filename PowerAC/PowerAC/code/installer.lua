...
RegisterCommand("PowerAC", function(source, args, rawCommand)
    if source == 0 then
        if args ~= nil then
            if args[1] == "install" then
                ...
                print("^2| [PowerAC] | Random installed on: ^3" .. RandomResource .. "  ^1Dont Stop this Resource!!!^7")
                print("^2| [PowerAC] | Installation Completed^7")
                print("^2| [PowerAC] | Your server will be restarted in 40 second^7")
                print("^3| [PowerAC] | To uninstall the anticheat run the command /uninstall^7")
                Citizen.Wait(40000)
                os.exit()
            ...
            elseif args[1] == "help" then
                print([[
                                        ...
                                        ^1//--HELP PowerAC Guide Command--\\^0
^1------------------------------------------------------------------------------------------------------------------------^0
                    To install the anticheat execute the command:                       ^2PowerAC install^0
    
^1------------------------------------------------------------------------------------------------------------------------^0
                    To install the random resource execute the command:                 ^2PowerAC installrandom^0
    
^1------------------------------------------------------------------------------------------------------------------------^0
                    To uninstall the anticheat from the server execute the command:     ^2PowerAC uninstall^0
...
^1------------------------------------------------------------------------------------------------------------------------^0
        ...
        print("^1| [PowerAC] | ID: "..source.." You cannot run commands from the client side. idiot^7")
    end
end)
...
function Unistall()
    Citizen.CreateThread(function()
        ...
        print("^1| [PowerAC] | uninstalled on " .. a .. " resources^7")
        print("^3| [PowerAC] | Delete String on Resource and Fxmanifest^7")
        print("^3| [PowerAC] | Please wait...^7")
    end)
end
...
function DisistallaStringeResource1()
    Citizen.CreateThread(function()
        ...
        print("^2| [PowerAC] | Uninstall Anticheat Complete^7")
        print("^1| [PowerAC] | Please restart the server^7")
    end)
end
